...
cloudWaveInterIB::cloudWaveInterIB
(
    const fvMesh& mesh
)
:
...
// * * * * * * * * * * * * * * * Member Functions  * * * * * * * * * * * * * //
void Foam::cloudWaveInterIB::getDEMdata()
{
    cfdemCloud::getDEMdata();
    dataExchangeM().getData("omega","vector-atom",angularVelocities_);
}

bool Foam::cloudWaveInterIB::reAllocArrays() const
{
    if(cfdemCloud::reAllocArrays())
    {
        Info <<"Foam::cloudWaveInterIB::reAllocArrays()"<<endl;
...
void Foam::cloudWaveInterIB::giveDEMdata()
{
...
inline double ** Foam::cloudWaveInterIB::DEMTorques() const
{
    return DEMTorques_;
}


bool Foam::cloudWaveInterIB::evolve
(
...
void Foam::cloudWaveInterIB::setInterFace
(
    volScalarField& interFace,
    volScalarField& alpha1
)
...
void Foam::cloudWaveInterIB::calcVelocityCorrection
(
    volScalarField& rho,
    volScalarField& p,
    volVectorField& U,
...
// 将DEM计算结果映射到CFD网格中
// 设置权重 ???
void Foam::cloudWaveInterIB::setParticleVelocity
(
    volVectorField& U,
...
vector Foam::cloudWaveInterIB::angularVelocity(int index)
{
    vector vel;
...
double Foam::cloudWaveInterIB::getTortuosity(vector dir)
{
...
// * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * //
void cloudWaveInterIB::setRefinementField(volScalarField* refine_)
{
...
const volVectorField& cloudWaveInterIB::interIBDragPerV(const volVectorField& U,const volScalarField& p)
{
...
const volVectorField& cloudWaveInterIB::IBDragPressPerV(const volVectorField& U,const volScalarField& p)
{
...
const volVectorField& cloudWaveInterIB::IBDragViscoPerV(const volVectorField& U,const volScalarField& p)
{
